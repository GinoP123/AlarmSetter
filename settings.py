...
open_file_script = "/usr/local/bin/sublime" if not open_file_script else open_file_script
open_file_script = shutil.which("vim") if not open_file_script else open_file_script
